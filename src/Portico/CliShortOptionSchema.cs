...
/// <summary>
/// Describes the arity of a single-character short option — flag (takes no value) or scalar
/// (takes exactly one value). The POSIX preprocessing step
/// (<see cref="CliShortOptionExpander.Expand"/>) uses this to decide how to split combined
/// tokens: <c>-abc</c> becomes <c>-a -b -c</c> if all three are flags; <c>-n5</c> becomes
/// <c>-n 5</c> if <c>-n</c> is scalar; mixed cases split at the first non-flag.
/// </summary>
