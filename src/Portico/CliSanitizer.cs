...
internal static class CliSanitizer
{
    ...
    private static bool IsAllowed(char c)
    {
        ...
        // (U+200B-U+200F), the bidi overrides (U+202A-U+202E), the word joiner (U+2060) and the BOM
        // (U+FEFF). Text nobody can see is still text in an agent's context window.
